...
- [호치민 장어 전문점 심층 프로파일 (PDF)](reports/hcmc-unagi-competitors-2026-08.pdf) — 인포그래픽(타임라인·가격 스펙트럼·분포 지도·자본 구조도) + 전문 5개사·인접 2개사 상세(메뉴 가격표·지점별 좌석·배달·프로모션), 조사·검증 2단 파이프라인 27기 기반, 항목별 판정 태그 (2026-08-20 심층판)
